...
getHiddenCombinations(3, 5)



max_neurons = 5
max_hidden = 2
cout = max_neurons * max_hidden
cout = cout - 1

(10 % (max_neurons)) + 1

int((max_neurons**(0) + 5) / max_neurons**(0))


(max_neurons+0 % (max_neurons*2)) + 1


int(cout / max_neurons)
int(cout / (max_neurons*2))
count = 0
[(lambda i: int((count % max_neurons**(i+1)) / max_neurons**i) + 1)(i)
 for i in range(max_hidden)]
int(10/10)

(lambda count, i: int(((count % max_neurons**i+1)) / max_neurons**i) + 1)

i = 0
int(((count % max_neurons**1)) / max_neurons**i) + 1
i = i + 1
#
print()
